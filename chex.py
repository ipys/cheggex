...
TELEGRAM_TOKEN = "1766887495:AAGc4f72Or-3qAPd89MJJRrcmV0aZ8A1qmw"
...
def send_welcome(message):
    if message.chat.type == 'supergroup':
        bot.reply_to(message, "✅ اهلا بك في بوت البحث عن سوال ضمن موقع جيك 👇🏻👇🏻\n"
                            ...
                            "2- سوف يتم الرد عليك بروابط 80% تحتوي على سوالك ، اذا كان سوالك من ضمن روابط قم بنسخ الرابط و إرساله إلى @engineeringanswerbot \n"
        ...
        if message.chat.type == 'supergroup':
            ...
            for i in m['data']['search']['study']['responseContent']['docs']:
                ...
                bot.reply_to(message, "Links 📍🌐 :\n\n" + us + "\n\n ⏱ Time : " + str(
                    mma) + "\n\nBy Abdulrahman Ghazi\n\nGo to bot to get solution @engineeringanswerbot ✅✅\n\nBest Wishes")
    except:
